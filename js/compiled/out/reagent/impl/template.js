...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25749__auto__,writer__25750__auto__,opt__25751__auto__){
return cljs.core._write.call(null,writer__25750__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__26908 = o;
(G__26908[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__26909__delegate = function (args){
...
while (G__26910__i < G__26910__a.length) {G__26910__a[G__26910__i] = arguments[G__26910__i + 0]; ++G__26910__i;}
  args = new cljs.core.IndexedSeq(G__26910__a,0);
} 
return G__26909__delegate.call(this,args);};
...
return G__26909__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__25131__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__25131__auto__){
var and__25131__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__26917 = jsprops;
(G__26917["defaultValue"] = value);

(G__26917["onChange"] = ((function (G__26917,v,value,on_change){
return (function (p1__26914_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26914_SHARP_);
});})(G__26917,v,value,on_change))
);

(G__26917["ref"] = ((function (G__26917,v,value,on_change){
return (function (p1__26915_SHARP_){
return (this$["cljsInputElement"] = p1__26915_SHARP_);
});})(G__26917,v,value,on_change))
);
...
var vec__26924 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26924,(0),null);
var id = cljs.core.nth.call(null,vec__26924,(1),null);
var class$ = cljs.core.nth.call(null,vec__26924,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___26929 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___26929 == null)){
} else {
var key_26930 = temp__4661__auto___26929;
(jsprops["key"] = key_26930);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__26932 = (new reagent.impl.template.NativeWrapper());
(G__26932["name"] = c);
...
var len__26218__auto___26938 = arguments.length;
var i__26219__auto___26939 = (0);
while(true){
if((i__26219__auto___26939 < len__26218__auto___26938)){
args__26225__auto__.push((arguments[i__26219__auto___26939]));

var G__26940 = (i__26219__auto___26939 + (1));
i__26219__auto___26939 = G__26940;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26226__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26936){
var G__26937 = cljs.core.first.call(null,seq26936);
var seq26936__$1 = cljs.core.next.call(null,seq26936);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__26937,seq26936__$1);
});
...
break;
default:
var G__26944 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__26944;
continue;
...
var n__26058__auto___26947 = a.length;
var i_26948 = (0);
while(true){
if((i_26948 < n__26058__auto___26947)){
(a[i_26948] = reagent.impl.template.as_element.call(null,(a[i_26948])));

var G__26949 = (i_26948 + (1));
i_26948 = G__26949;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__26058__auto___26950 = a.length;
var i_26951 = (0);
while(true){
if((i_26951 < n__26058__auto___26950)){
var val_26952 = (a[i_26951]);
if((cljs.core.vector_QMARK_.call(null,val_26952)) && ((reagent.impl.template.key_from_vec.call(null,val_26952) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26951] = reagent.impl.template.as_element.call(null,val_26952));
...
var ctx = ({});
var vec__26957 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
...
var G__26961 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26961) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__26961){
...
//# sourceMappingURL=template.js.map?rel=1489243582600