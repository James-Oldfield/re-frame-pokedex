...
var vec__27598_27601 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_27602 = cljs.core.nth.call(null,vec__27598_27601,(0),null);
var only_after_27603 = cljs.core.nth.call(null,vec__27598_27601,(1),null);
var db_changed_QMARK__27604 = (cljs.core.some_QMARK_.call(null,only_before_27602)) || (cljs.core.some_QMARK_.call(null,only_after_27603));
if(db_changed_QMARK__27604){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_27602);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_27603);
...
var map__27611 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__27611__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__27611__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__27619 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__27619__$1;
var event = cljs.core.get.call(null,map__27619__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26218__auto___27622 = arguments.length;
var i__26219__auto___27623 = (0);
while(true){
if((i__26219__auto___27623 < len__26218__auto___27622)){
args__26225__auto__.push((arguments[i__26219__auto___27623]));

var G__27624 = (i__26219__auto___27623 + (1));
i__26219__auto___27623 = G__27624;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__26226__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq27621){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27621));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__25143__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__26225__auto__ = [];
var len__26218__auto___27630 = arguments.length;
var i__26219__auto___27631 = (0);
while(true){
if((i__26219__auto___27631 < len__26218__auto___27630)){
args__26225__auto__.push((arguments[i__26219__auto___27631]));

var G__27632 = (i__26219__auto___27631 + (1));
i__26219__auto___27631 = G__27632;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26226__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__27625_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__27626_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__27626_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq27627){
var G__27628 = cljs.core.first.call(null,seq27627);
var seq27627__$1 = cljs.core.next.call(null,seq27627);
var G__27629 = cljs.core.first.call(null,seq27627__$1);
var seq27627__$2 = cljs.core.next.call(null,seq27627__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__27628,G__27629,seq27627__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1489243585115