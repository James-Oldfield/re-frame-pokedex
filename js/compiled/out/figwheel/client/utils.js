...
return (new CustomEvent(event_name,(function (){var obj34357 = {"detail":data};
return obj34357;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__25131__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__25131__auto__)){
var and__25131__auto____$1 = (window["CustomEvent"]);
...
var args34362 = [];
var len__26218__auto___34368 = arguments.length;
var i__26219__auto___34369 = (0);
while(true){
if((i__26219__auto___34369 < len__26218__auto___34368)){
args34362.push((arguments[i__26219__auto___34369]));

var G__34370 = (i__26219__auto___34369 + (1));
i__26219__auto___34369 = G__34370;
continue;
} else {
}
break;
...
var f = (function (){var pred__34365 = cljs.core._EQ_;
var expr__34366 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34365.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34366))){
return ((function (pred__34365,expr__34366){
return (function (p1__34358_SHARP_){
return console.warn(p1__34358_SHARP_);
});
;})(pred__34365,expr__34366))
} else {
if(cljs.core.truth_(pred__34365.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34366))){
return ((function (pred__34365,expr__34366){
return (function (p1__34359_SHARP_){
return console.debug(p1__34359_SHARP_);
});
;})(pred__34365,expr__34366))
} else {
if(cljs.core.truth_(pred__34365.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34366))){
return ((function (pred__34365,expr__34366){
return (function (p1__34360_SHARP_){
return console.error(p1__34360_SHARP_);
});
;})(pred__34365,expr__34366))
} else {
return ((function (pred__34365,expr__34366){
return (function (p1__34361_SHARP_){
return console.log(p1__34361_SHARP_);
});
;})(pred__34365,expr__34366))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34372){
...
var eval_fn = cljs.core.get.call(null,map__34375__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34377_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34379,(0),null);
...
var args34382 = [];
var len__26218__auto___34385 = arguments.length;
var i__26219__auto___34386 = (0);
while(true){
if((i__26219__auto___34386 < len__26218__auto___34385)){
args34382.push((arguments[i__26219__auto___34386]));

var G__34387 = (i__26219__auto___34386 + (1));
i__26219__auto___34386 = G__34387;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args34382.length)].join('')));
...
if(cljs.core.truth_((function (){var and__25131__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1489243597105