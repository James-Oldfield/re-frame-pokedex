...
var o__38108__auto___41228 = (function (){var o__38108__auto__ = (function (){var o__38108__auto__ = Promise;
return goog.object.get(o__38108__auto__,"resolve").call(o__38108__auto__);
})();
return goog.object.get(o__38108__auto__,"then").call(o__38108__auto__,callback);
})();
goog.object.get(o__38108__auto___41228,"catch").call(o__38108__auto___41228,devtools.async.rethrow_outside_promise);
...
var G__41230_41231 = Error;
var target__38127__auto___41232 = G__41230_41231;
if(cljs.core.truth_(target__38127__auto___41232)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__41230_41231)].join('')),cljs.core.str("\n"),cljs.core.str("target__38127__auto__")].join('')));
}

goog.object.set(target__38127__auto___41232,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1489243614434