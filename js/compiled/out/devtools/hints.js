...
var reader = (function (){var or__25143__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__25143__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__25143__auto__)){
return or__25143__auto__;
} else {
return (128);
...
var line = cljs.core.get.call(null,map__41255__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__41255__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e41254){var _e = e41254;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___41257 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___41257)){
var seen_errors_41258 = temp__4655__auto___41257;
if(cljs.core.truth_(seen_errors_41258.has(self))){
} else {
seen_errors_41258.add(self);

var temp__4657__auto___41259 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___41259)){
var sense_41260 = temp__4657__auto___41259;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_41260)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1489243614766