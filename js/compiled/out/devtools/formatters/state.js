...
var len__26218__auto___40488 = arguments.length;
var i__26219__auto___40489 = (0);
while(true){
if((i__26219__auto___40489 < len__26218__auto___40488)){
args__26225__auto__.push((arguments[i__26219__auto___40489]));

var G__40490 = (i__26219__auto___40489 + (1));
i__26219__auto___40489 = G__40490;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26226__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq40486){
var G__40487 = cljs.core.first.call(null,seq40486);
var seq40486__$1 = cljs.core.next.call(null,seq40486);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__40487,seq40486__$1);
});
...
return (p1__40491_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1489243611899