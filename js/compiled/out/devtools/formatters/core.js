...
var and__25131__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__25131__auto__){
var or__25143__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e40938){var e__38133__auto__ = e40938;
return false;
...
}catch (e40940){var e__38133__auto__ = e40940;
return false;
...
}catch (e40946){var e__38133__auto__ = e40946;
return false;
...
}catch (e40948){var e__38133__auto__ = e40948;
return false;
...
}catch (e40954){var e__38133__auto__ = e40954;
return false;
}})())){
...
}catch (e40956){var e__38133__auto__ = e40956;
return false;
}})())){
...
var _STAR_current_state_STAR_40959 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__25143__auto__ = config;
if(cljs.core.truth_(or__25143__auto__)){
return or__25143__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40959;
}});
});
...
return (function() { 
var G__40962__delegate = function (args){
...
while (G__40963__i < G__40963__a.length) {G__40963__a[G__40963__i] = arguments[G__40963__i + 0]; ++G__40963__i;}
  args = new cljs.core.IndexedSeq(G__40963__a,0);
} 
return G__40962__delegate.call(this,args);};
G__40962.cljs$lang$maxFixedArity = 0;
G__40962.cljs$lang$applyTo = (function (arglist__40964){
var args = cljs.core.seq(arglist__40964);
return G__40962__delegate(args);
});
...
var pre_handler = (function (){var or__25143__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__25143__auto__)){
return or__25143__auto__;
} else {
...
var post_handler = (function (){var or__25143__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__25143__auto__)){
return or__25143__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1489243613581