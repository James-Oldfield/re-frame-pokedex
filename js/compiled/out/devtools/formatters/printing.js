...
var len__26218__auto___40497 = arguments.length;
var i__26219__auto___40498 = (0);
while(true){
if((i__26219__auto___40498 < len__26218__auto___40497)){
args__26225__auto__.push((arguments[i__26219__auto___40498]));

var G__40499 = (i__26219__auto___40498 + (1));
i__26219__auto___40498 = G__40499;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26226__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq40494){
var G__40495 = cljs.core.first.call(null,seq40494);
var seq40494__$1 = cljs.core.next.call(null,seq40494);
var G__40496 = cljs.core.first.call(null,seq40494__$1);
var seq40494__$2 = cljs.core.next.call(null,seq40494__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__40495,G__40496,seq40494__$2);
});
...
if(cljs.core.truth_((function (){var or__25143__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25749__auto__,writer__25750__auto__,opt__25751__auto__){
return cljs.core._write.call(null,writer__25750__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__25131__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__25131__auto__){
var or__25143__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__25143__auto__)){
return or__25143__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__40500_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__40500_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__40509__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__25143__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e40513){var e__38133__auto__ = e40513;
return false;
}})();
if(cljs.core.truth_(or__25143__auto__)){
return or__25143__auto__;
...
}catch (e40515){var e__38133__auto__ = e40515;
return false;
}}
})())){
...
var _STAR_current_state_STAR_40520 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__40521 = opts;
...
var markup_db = cljs.core.get.call(null,map__40521__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40520;
}});
...
;
var temp__4655__auto___40526 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___40526)){
var managed_print_level_40527 = temp__4655__auto___40526;
var _STAR_print_level_STAR_40525_40528 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_40527;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_40525_40528,managed_print_level_40527,temp__4655__auto___40526,writer,opts,job_fn){
return (function (p1__40523_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__40523_SHARP_,null);
});})(_STAR_print_level_STAR_40525_40528,managed_print_level_40527,temp__4655__auto___40526,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_40525_40528;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1489243612122